...
func TestStuff(t *testing.T) {
	...
	graph, exists := processed.PresentationTreesByRole["http://fasb.org/us-gaap/role/statement/StatementOfFinancialPositionClassified"]
	require.True(t, exists)

	graph.Traverse(func(node *PresentationNode, depth int) bool {
